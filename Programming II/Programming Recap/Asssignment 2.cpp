...
//
//
//     This program revises programming concepts from the previous semester. Two additional
//     functions were added as part of Assignment 2.
//
//
...
int main()
{
    ...
    cout << "Highest test score for Student #" << studentNumber << " is: " << highest4Stud
         << endl;
    pressEnter ();
    ...
    cout << "Please enter an average test score." << endl;
    cin >> userAvg;
    cout << endl;

    if (searchStudents (testScores, NUM_STUDENTS, userAvg))
    {
        cout << "A student does have an average score greater than: " << userAvg << endl;
    }
    else
    {
        cout << "A student does not have an average score greater than: " << userAvg << endl;
    }
    pressEnter ();

    if (searchTests (testScores, NUM_STUDENTS, userAvg))
    {
        cout << "A test does have an average score greater than: " << userAvg << endl;
    }
    else
    {
        cout << "A test does not have an average score greater than: " << userAvg << endl;
    }
    pressEnter ();
...
bool searchStudents (const int scores [][NUM_TESTS], int numStds, double average)
{
    ...
    for (int i = 0; i < numStds; i++)
    {
        searched = averageOneStudent (scores, numStds, i);
...
bool searchTests (const int scores [][NUM_TESTS], int numStds, double average)
{
    ...
    for (int i = 0; i < NUM_TESTS; i++)
    {
        searched = averageOneTest (scores, numStds, i);
...
A student does not have an average score greater than: 98.00
Press Enter to Continue

A test does not have an average score greater than: 98.00
Press Enter to Continue
